...
const GoBackButton: React.FC = () => {
  ...
  return (
    <button
      onClick={() => navigate(-1)}
      className="absolute left-0 top-0 bg-violet pl-8 pt-8 md:top-2 lg:left-2 xl:left-4 2xl:left-8"
    >
      <svg
        width="7"
        height="14"
      ...
      <span className="hidden rounded-lg border border-white bg-violet px-4 py-2 text-white hover:bg-violet-800 md:block">
        Назад
      </span>
    </button>
  );
